...
(gen_random_uuid(), 'admin@ghosthub.demo', '$2b$12$LQv3c1yqBwEHxv68UVgAiO1.Q0IKEWKhLzxg2.fGQK8BmL.3K9FX6', 'Admin', 'User', 'admin', true, 150.00, 'Management', '555-0100', 'UTC'),
(gen_random_uuid(), 'tech@ghosthub.demo', '$2b$12$LQv3c1yqBwEHxv68UVgAiO1.Q0IKEWKhLzxg2.fGQK8BmL.3K9FX6', 'John', 'Smith', 'technician', true, 125.00, 'Technical', '555-0101', 'UTC'),
(gen_random_uuid(), 'sarah@ghosthub.demo', '$2b$12$LQv3c1yqBwEHxv68UVgAiO1.Q0IKEWKhLzxg2.fGQK8BmL.3K9FX6', 'Sarah', 'Johnson', 'technician', true, 130.00, 'Technical', '555-0102', 'UTC'),
(gen_random_uuid(), 'mike@ghosthub.demo', '$2b$12$LQv3c1yqBwEHxv68UVgAiO1.Q0IKEWKhLzxg2.fGQK8BmL.3K9FX6', 'Mike', 'Davis', 'manager', true, 175.00, 'Technical', '555-0103', 'UTC'),
(gen_random_uuid(), 'billing@ghosthub.demo', '$2b$12$LQv3c1yqBwEHxv68UVgAiO1.Q0IKEWKhLzxg2.fGQK8BmL.3K9FX6', 'Lisa', 'Brown', 'billing', true, 95.00, 'Finance', '555-0104', 'UTC')
...
BEGIN
    ...
    SELECT id INTO admin_user_id FROM users WHERE email = 'admin@ghosthub.demo';
    SELECT id INTO tech_user_id FROM users WHERE email = 'tech@ghosthub.demo';
    SELECT id INTO sarah_user_id FROM users WHERE email = 'sarah@ghosthub.demo';
