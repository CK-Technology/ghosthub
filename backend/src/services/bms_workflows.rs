            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <p>Thank you for choosing GhostHub for your business needs.</p>
                        
                        <p>Best regards,<br>The GhostHub Team</p>
                    </div>
                    <div class="footer">
                        <p>GhostHub MSP Services | Questions? Reply to this email</p>
                    </div>
                </div>
            </body>
            </html>
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <p>Sincerely,<br>GhostHub Billing Department</p>
                    </div>
                    <div class="footer">
    ...
    async fn send_time_tracking_reminder(&self, email: &str, name: &str) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
        ...
        let html_body = format!(
            ...
            <body style="font-family: Arial, sans-serif; padding: 20px;">
                ...
                <p>Please log into GhostHub to record your time entries for today.</p>
                <p>Thank you!</p>
            </body>
            </html>
            "#,
