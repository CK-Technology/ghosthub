...
pub struct ITDocOverview {
    ...
    pub expiring_domains: Vec<ghosthub_shared::Domain>,
    pub expiring_ssl_certificates: Vec<ghosthub_shared::SslCertificate>,
    pub expiring_licenses: Vec<ghosthub_shared::SoftwareLicense>,
}
...
async fn get_itdoc_overview(
    ...
    let expiring_ssl_certificates = sqlx::query_as!(
        ghosthub_shared::SslCertificate,
        r#"
    ...
    let expiring_licenses = sqlx::query_as!(
        ghosthub_shared::SoftwareLicense,
        r#"
